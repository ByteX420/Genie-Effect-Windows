...
namespace WindowMotion {
  ...
  inline ui::motion::MotionSystem& System() {
    return g_system;
  }

  inline ui::motion::MotionTokens& Tokens() {
    return g_tokens;
  }

  inline void BeginFrame( float deltaTime ) {
    g_system.beginFrame( deltaTime );
  }
