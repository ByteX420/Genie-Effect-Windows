...
namespace ImGui
{
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/ui/imgui/issues/3361
    ...
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags);
...
// Read details about the 1.87 and 1.89 transition : https://github.com/ocornut/ui/imgui/issues/4921
...
struct ImFontAtlas
{
    ...
    // Read https://github.com/ocornut/ui/imgui/blob/master/docs/FONTS.md/#about-utf-8-encoding for details.
...
namespace ImGui
{
    ...
    //-- OBSOLETED in 1.78 (from June 2020): Old drag/sliders functions that took a 'float power > 1.0f' argument instead of ImGuiSliderFlags_Logarithmic. See github.com/ocornut/ui/imgui/issues/3361 for details.
