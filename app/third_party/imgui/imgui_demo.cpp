...
//   - Read Getting Started https://github.com/ocornut/ui/imgui/wiki/Getting-Started
...
// - Use the Item Picker to debug break in code by clicking any widgets: https://github.com/ocornut/ui/imgui/wiki/Debug-Tools
...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Images")) {
    ...
    // - Read https://github.com/ocornut/ui/imgui/blob/master/docs/FAQ.md
    // - Read https://github.com/ocornut/ui/imgui/wiki/Image-Loading-and-Displaying-Examples
    ...
    for (int i = 0; i < 8; i++) {
      ...
      // Read about UV coordinates here: https://github.com/ocornut/ui/imgui/wiki/Image-Loading-and-Displaying-Examples
      ImGui::PushID(i);
      if (i > 0)
  ...
  // (see others https://github.com/ocornut/ui/imgui/wiki/Useful-Extensions)
